...
class GWOTunerNode(Node):
    ...
    def load_configs(self):
        # ... (Same as before)
        # Paths
        pkg_share = os.path.dirname(__file__) # Assumes same dir
        mpc_config_path = os.path.join(pkg_share, 'config/mpc_config.yaml')
        gwo_config_path = os.path.join(pkg_share, 'config/gwo_config.yaml')
    ...
    def save_best_params(self, weights):
        ...
        save_path = os.path.join(pkg_share, 'config/mpc_best_params.yaml')
